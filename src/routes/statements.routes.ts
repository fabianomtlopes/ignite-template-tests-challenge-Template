...
import {CreateTransferenceController} from '../modules/statements/useCases/createTransference/CreateTransferenceController';
...
statementRouter.post('/transfers/:recipient_id', createTransferenceController.handle);
